...
submitBtn.addEventListener('click', function () {
  ...
  const clientOpts = {
    network: 'testnet',
    mnemonic: 'grid bind gasp long fox catch inch radar purchase winter woman cactus',  // vendor 
    apps: {
      messageContract: {
        contractId: 'ConeoUukuVZ9dG2P9U34AgrrDqe7ukveA6n5XGUxqAoT'  // message contract
      }
    }
  };
  ...
  const submitNoteDocument = async function () {
    ...
    try {
      ...
      const identity = await client.platform.identities.get('FJ85ReAdCiBBRy39JcrYJo8YkoJLa5oSMpziXYoSJ2a7');  // vendor identity
